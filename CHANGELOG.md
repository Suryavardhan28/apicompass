...
- Added automated publishing workflow for VS Code Marketplace and OpenVSX releases.

### Changed

- Improved extension release pipeline with GitHub Actions-based publishing.
- Added Cursor/OpenVSX distribution support.

## [0.1.4] - 2026-05-14

### Added

- Added `apicompass.curlBaseUrl` (default: `http://localhost:3000`) for the **Copy as cURL** command.
